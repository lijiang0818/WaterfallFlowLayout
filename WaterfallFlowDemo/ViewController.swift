...
//  WaterfallFlowDemo
//
//  Created by lijiang on 2020/7/17.
...
extension ViewController: WaterfallFlowLayoutDelegate {
  ...
  func referenceSizeForHeader(collectionView collection: UICollectionView, layout: WaterfallFlowLayout, section: Int) -> CGSize {
    return CGSize(width: self.view.frame.size.width, height: 40)
  }
  
  func referenceSizeForFooter(collectionView collection: UICollectionView, layout: WaterfallFlowLayout, section: Int) -> CGSize {
  ...
  func spacingWithLastSection(collectionView collection: UICollectionView, layout: WaterfallFlowLayout, section: Int) -> CGFloat {
    return 15
  }
}
